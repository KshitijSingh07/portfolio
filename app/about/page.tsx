...
// Removed import Image from "next/image" as it caused a resolution error in this environment.
        ...
        <div className="min-h-screen px-6 py-10 md:px-20 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
                ...
                <div className="shrink-0 relative w-52 h-52 sm:w-60 sm:h-60 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-blue-500 shadow-md">
                    {/* Replaced Next.js Image component with a standard <img> tag to resolve the compilation error. */}
                    <img
                        src="/kshitij.jpg"
                        alt="Kshitij Singh"
                        // Added w-full and h-full to make the image fill its container, similar to 'fill' prop of Next.js Image.
                        className="object-cover w-full h-full"
                        // 'sizes' prop is specific to Next.js Image and not applicable here.
                    />
                </div>
